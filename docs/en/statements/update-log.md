...
- **[🔨Fix]** Fixed the issue where international server announcements could not be retrieved
...
- **[🔨Fix]** Fixed the issue where the game resource pre-download might get stuck
