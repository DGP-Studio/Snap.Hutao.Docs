...
## 胡桃什么时候可以上架微软商店
- 胡桃的核心功能之一：[高级启动器](https://hut.ao/features/game-launcher.html#%E8%B4%A6%E5%8F%B7%E4%BF%9D%E5%AD%98)中的多个功能均**不满足**微软商店对于上架应用的规则
  - 例如：胡桃工具箱在切换**游戏内**账号时，将对**未虚拟化的注册表**进行操作，以达到切换游戏账号的目的
- 若胡桃工具箱在完善后上架微软商店，则将对不满足上架规则的功能进行删减
- 综上所述，建议您保持使用**并不繁琐**的自行安装的方式，以获得完整的使用体验
