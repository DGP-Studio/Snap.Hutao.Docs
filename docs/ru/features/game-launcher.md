...
::: caution
Использование любого неофициального программного обеспечения может повлечь риск для ваших виртуальных активов, продолжение использования функций этого программного обеспечения означает, что вы уже знаете об этом и согласны с нашими [условиями использования](/statements/tos.md).
:::
