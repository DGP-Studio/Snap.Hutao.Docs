...
无论是国服账号还是国际服账号，你都有 `网页登录` 和 `Cookie登录` 两种登录方式。 对于使用米游社手机应用并绑定国服游戏账号的用户，可以选择 `扫码登录`。 <font color="red">无论你使用何种方式登录，请务必确定你已经使用官方应用登录并使用过米哈游论坛并设置过社区用户名以初始化你的账号，否则 Snap Hutao 将无法获取你的账号信息。</font>
