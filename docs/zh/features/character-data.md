...
order: 8
comment: false
description: 胡桃工具箱的我的角色功能可以读取原神账号下所拥有的角色的具体数据进行展示并提供分析数据，包括等级、命之座、天赋和圣遗物评分等数据。
---

# 我的角色

::: info 前置要求
该功能需要你在胡桃工具箱中登录米游社账号，登录方法可见[米游社多账号切换](mhy-account-switch.md#米游社多账号切换)文档
:::

我的角色功能可读取当前账号所拥有角色的具体数据，包括等级、命之座、武器、天赋、圣遗物等；并自动计算圣遗物评分和双爆评分
