...
order: 4
comment: false
description: 胡桃工具箱内的游戏启动器相交于官方启动器，不仅允许用户添加自定义的启动参数，还内置了服务器转换和解锁帧率等显著提升游戏体验的功能。
---
...
- 进入 “启动游戏” 功能页面
- 在 “进程” 栏目中，启用 “启动参数” 功能，点击展开后你可以设置更多细节：
...
启用该功能后，胡桃将会调用 Better Genshin Impact 的通信接口，使其在 Snap Hutao 启动游戏后，启动其基于计算机视觉技术的自动化功能。
