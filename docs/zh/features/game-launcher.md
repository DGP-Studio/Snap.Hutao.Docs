...
原神目前内置了仅能通过设置注册表键值开启的 HDR 功能，虽然这可能意味着该功能属于游戏的测试功能，但是你已经能够抢先体验！
...
当用户需要进行游戏版本升级时，可以执行以下步骤或使用胡桃的升级功能：
...
::: caution
请注意，注入功能使用不当极有可能损坏您的设备与资料，启用即代表您选择自行承担可能导致的一切风险。**本功能需要以管理员权限启动胡桃工具箱。**
:::

### 帧率限制解除

::: caution
本功能依赖 [UnlockerIsland 项目](https://github.com/DGP-Studio/UnlockerIsland)，使用本功能意味着您认可并接受我们的[用户协议](../statements/tos.md#总则)相关内容。请注意，使用本功能所造成的一切可能的不良后果均由使用者自行承担。
:::
...
::: warning
本功能**在且仅在**正常状态下可切换队伍时生效（限制与游戏内相同）。请各位内容创作者在创作相关内容时**不要使用与提及本功能**。
:::
